                        ...
                        <form action="{{route('tanah.update', $edit->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-body ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <label class="col-form-label">Kategori Aset</label>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" name="luas" value="{{$edit->luas}}" placeholder="">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class=" col-form-label">Unit Aset</label>
                                        <input type="number" class="form-control" name="stok" value="{{$edit->stok}}" placeholder="Aset Tersedia">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
